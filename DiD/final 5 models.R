...
for (tm in 2:2){
  ...
  for (p in c(1,3,5,6,7,14)){
    ...
    marketdat$inter_3_months_lag = as.factor(marketdat$inter_3_months_lag)
    ...
    try({
      ...
      feanames = c("market","date","state",
                   ...
                   "amount", "rainfall","rainfall_lead1","rainfall_lead2","rainfall_lead3","rainfall_lead4"
                   ,"rainfall_lead5","rainfall_lead6","rainfall_lead7","rainfall_lead8","rainfall_lead9"
                   ,"rainfall_lead10","rainfall_lead11","rainfall_lead12","inter","modal","wpi","time")
      d = d[,feanames]
      d = na.omit(d)
      
      fit3 = lm(log(modal)~ market+date+state:time+
                  annual+total_ar+lit_ru+ptmrkt+agrl_t+
                  Per.Capita.GSDP+production+yield+
                  log(amount)+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
                +rainfall_lead10+rainfall_lead11+rainfall_lead12+inter+0,
                data=d)
      l3 = lm.cluster(log(modal)~ market+date+state:time+
                        annual+total_ar+lit_ru+ptmrkt+agrl_t+
                        Per.Capita.GSDP+production+yield+
                        log(amount)+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                      +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
    ...
    try({
      ...
      feanames = c("market","date",
                   ...
                   "amount", "rainfall","rainfall_lead1","rainfall_lead2","rainfall_lead3","rainfall_lead4"
                   ,"rainfall_lead5","rainfall_lead6","rainfall_lead7","rainfall_lead8","rainfall_lead9"
                   ,"rainfall_lead10","rainfall_lead11","rainfall_lead12","inter","modal","wpi","time","treat")
      d = d[,feanames]
      d = na.omit(d)
      
      fit6 = lm(log(modal)~ market+date+
                  annual+total_ar+lit_ru+ptmrkt+agrl_t+
                  Per.Capita.GSDP+production+yield+
                  log(amount)+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
                +rainfall_lead10+rainfall_lead11+rainfall_lead12+time+treat:time+0,
                data=d)
      l6 = lm.cluster(log(modal)~ market+date+
                        annual+total_ar+lit_ru+ptmrkt+agrl_t+
                        Per.Capita.GSDP+production+yield+
                        log(amount)+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                      +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
    ...
    try({
      ...
      fit7 = lm(log(modal)~ market+date+
                ...
                +rainfall_lead10+rainfall_lead11+rainfall_lead12+inter+0,
                data=d)
      l7 = lm.cluster(log(modal)~ market+date+
                        annual+total_ar+lit_ru+ptmrkt+agrl_t+
                        Per.Capita.GSDP+production+yield+
                        log(amount)+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                      +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
    ...
    dir.create(paste("/Users/tangjingwen/Dropbox/jingwen_tasks/organized/result/DiD/not add vdsa/",timemode,sep = ""))
    dir.create(paste("/Users/tangjingwen/Dropbox/jingwen_tasks/organized/result/DiD/not add vdsa/",timemode,"/",product,sep = ""))
    setwd(paste("/Users/tangjingwen/Dropbox/jingwen_tasks/organized/result/DiD/not add vdsa/",timemode,"/",product,sep = ""))
    ...
    write.csv(crse6,paste(product,"parallel.csv"))
    a1 = stargazer(crse1)
    a2 = stargazer(crse2)
    a3 = stargazer(crse3)
    a4 = stargazer(crse4)
    ...
    write(a6,paste(product,"parallel.txt"))
    ...
    try({re[91,] = crse6[rownames(crse6)=="time:treatTRUE",]})
    try({re[92,] = crse7[rownames(crse7)=="inter1",]})
    ...
    trial = c(trial,"parallel","placebo")
   ...
   saveWorkbook(wb,paste("/Users/tangjingwen/Dropbox/jingwen_tasks/organized/result/DiD/not add vdsa/",timemode," inter coefficients.xlsx",sep = ""),overwrite = T)
