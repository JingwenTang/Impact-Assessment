...
library(stringi)
library(lubridate)
Timemode = c("13-17 week","13-17 week all","13-17 month common types","13-17 month all common types",
...
for (tm in c(1,2,5,6)){
  ...
  for (p in 1:length(Product)){
    ...
    try({
      ...
      fit1 = lm(log(modal)~ market+date+month:treat+annual+total_ar+lit_ru+ptmrkt+agrl_t+
    ...
    print(2)
    try({
      fit2 = lm(CV~ state+ date+month:treat  +annual+total_ar+lit_ru+ptmrkt+agrl_t+
                  Per.Capita.GSDP+production+yield+
    ...
    print(3)
    try({
      fit3 = lm(VWCV~ state+ date+month:treat +production+yield+
    ...
    print(4)
    try({
      fit4 = lm(R~ state+ date+month:treat +annual+total_ar+lit_ru+ptmrkt+agrl_t+
                  Per.Capita.GSDP+production+yield+
                  amount+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
                +rainfall_lead10+rainfall_lead11+rainfall_lead12+ no.inter+0 ,
    ...
    try({
      ...
      fit5 = lm(log(modal)~ Per.Capita.GSDP+production+yield+annual+total_ar+lit_ru+ptmrkt+agrl_t+
                  log(amount)+market+time  + date+month:treat+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
    ...
    try({
      ...
      fit6 = lm(log(modal)~ Per.Capita.GSDP+production+yield+annual+total_ar+lit_ru+ptmrkt+agrl_t+
                  log(amount)+market + date+month:treat + rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
                +rainfall_lead10+rainfall_lead11+rainfall_lead12+inter+0 ,
                data=d)
    ...
    try({
      ...
      fit8 = lm(log(modal)~ market + date+month:treat +inter +0,
                data=d)
    ...
    try({
      ...
      fit9 = lm(log(modal)~ market+date+month:treat+production+yield+
                  Per.Capita.GSDP+annual+total_ar+lit_ru+ptmrkt+agrl_t+
                  log(amount)+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
                +rainfall_lead10+rainfall_lead11+rainfall_lead12+inter+0,
    ...
    print(10)
    try({
      fit10 = lm(wmean~ state+ date+month:treat +production+yield+
                   Per.Capita.GSDP+annual+total_ar+lit_ru+ptmrkt+agrl_t+
                   amount+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                 +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
    ...
    try({
      ...
      fit11 = lm(log(modal)~ state+ date+month:treat +production+yield+
                   Per.Capita.GSDP+annual+total_ar+lit_ru+ptmrkt+agrl_t+
                   log(amount)+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                 +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
                 +rainfall_lead10+rainfall_lead11+rainfall_lead12+ volume_fraction +0,
    ...
    try({
      ...
      fit12 = lm(log(modal)~ market+date+month:treat +production+yield+annual+total_ar+lit_ru+ptmrkt+agrl_t
    ...
    try({
      ...
      fit13 = lm(log(modal)~ market+date+month:treat +production+yield+annual+total_ar+lit_ru+ptmrkt+agrl_t
                 +Per.Capita.GSDP+log(amount)+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                 +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
                 +rainfall_lead10+rainfall_lead11+rainfall_lead12+inter+0,
                 data=d,weights = w)
    ...
    try({
      ...
      if (br=="week"){
        fit14 = lm(log(modal)~ market+week + month + date +month:treat+production+yield+annual+total_ar+lit_ru+ptmrkt+agrl_t+
                     Per.Capita.GSDP+log(amount)+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                   +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
                   +rainfall_lead10+rainfall_lead11+rainfall_lead12+inter+0 ,
                   data=d)
      ...
      if (br=="month"){
        fit14 = lm(log(modal)~ market + month + date+month:treat +production+yield+
    ...
    try({
      ...
      d = na.omit(d)
      fit15 = lm(log(modal)~ state + state:timenumber +market+date +month:treat+
    ...
    try({
      ...
      fit16 = lm(log(modal)~ market + market:timenumber +date+month:treat+production+yield+
                   Per.Capita.GSDP+annual+total_ar+lit_ru+ptmrkt+agrl_t+
                   log(amount)+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                 +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
                 +rainfall_lead10+rainfall_lead11+rainfall_lead12+ inter+0,
    ...
    print(17)
    try({
      fit17 = lm(wmean~ state+ date +month:treat+annual+total_ar+lit_ru+ptmrkt+agrl_t+
                   Per.Capita.GSDP+production+yield+
                   amount+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                 +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
                 +rainfall_lead10+rainfall_lead11+rainfall_lead12+ no.inter +0,
    ...
    try({
      ...
      fit18 = lm(log(modal)~ state+ date+month:treat+annual+total_ar+lit_ru+ptmrkt+agrl_t+
                   Per.Capita.GSDP+
                   log(amount)+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                 +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
                 +rainfall_lead10+rainfall_lead11+rainfall_lead12+ no.inter +0,
    ...
    try({
      ...
      fit19 = lm(log(modal)~ market+date+month:treat +production+yield+
                   Per.Capita.GSDP+annual+total_ar+lit_ru+ptmrkt+agrl_t+
                   log(amount)+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                 +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
                 +rainfall_lead10+rainfall_lead11+rainfall_lead12+ lead+lead4+lead3+lead2+lead1+lag1+lag2 +0,
                 data=d)
    ...
    try({
      ...
      fit20 = lm(CV~ state+ date +month:treat +annual+total_ar+lit_ru+ptmrkt+agrl_t+
                   Per.Capita.GSDP+production+yield+
                   amount+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                 +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
                 +rainfall_lead10+rainfall_lead11+rainfall_lead12+ no.inter +0,
    ...
    try({
      dat = dat[(dat$date<min(interdate2))|(dat$date>=max(interdate2)),]
      fit21 = lm(VWCV~ state+ date +month:treat+production+yield+
                   Per.Capita.GSDP+annual+total_ar+lit_ru+ptmrkt+agrl_t+
                   amount+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                 +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
                 +rainfall_lead10+rainfall_lead11+rainfall_lead12+ no.inter+0,
    ...
    try({
      dat = dat[(dat$date<min(interdate2))|(dat$date>=max(interdate2)),]
      fit22 = lm(R~ state+ date +month:treat+
                   Per.Capita.GSDP+production+yield+annual+total_ar+lit_ru+ptmrkt+agrl_t+
                   amount+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                 +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
                 +rainfall_lead10+rainfall_lead11+rainfall_lead12+ no.inter+0 ,
    ...
    try({
      ...
      d = join(d,wei,by = "market",type = "left")
      d = na.omit(d)
      fit23 = lm(log(modal)~ market+date+month:treat +production+yield+annual+total_ar+lit_ru+ptmrkt+agrl_t
                 +Per.Capita.GSDP+log(amount)+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                 +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
                 +rainfall_lead10+rainfall_lead11+rainfall_lead12 + inter +0,
                 data=d,weights = w)
    ...
    try({
      ...
      d = join(d,wei,by = "market",type = "left")
      d = na.omit(d)
      fit24 = lm(log(modal)~ market+date +month:treat+production+yield+annual+total_ar+lit_ru+ptmrkt+agrl_t
                 +Per.Capita.GSDP+log(amount)+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                 +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
                 +rainfall_lead10+rainfall_lead11+rainfall_lead12+inter+0,
                 data=d,weights = w)
    ...
    try({
      ...
      fit25 = lm(log(modal)~ market+date+month:treat+
                   Per.Capita.GSDP+production+yield+annual+total_ar+lit_ru+ptmrkt+agrl_t+
                   log(amount)+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                 +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
    ...
    ###########################################
    #DiD for parallel with leads and lags weekly
    ###########################################
    print(26)
    try({
      d = marketdat
      ...
      fit26 = lm(log(modal)~ market+date +month:treat+production+yield+
                   Per.Capita.GSDP+annual+total_ar+lit_ru+ptmrkt+agrl_t+
                   log(amount)+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                 +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
                 +rainfall_lead10+rainfall_lead11+rainfall_lead12+ lead_2+lead4_2+lead3_2+lead2_2+lead1_2+lag1+lag2 +0,
                 data=d)
      
      crse26 = clx(fit26,1, d$market)
      crse26
    })
    ...
    try({
      ...
      fit27 = lm(log(modal)~ market+date +month:treat +production+yield+
                   Per.Capita.GSDP+annual+total_ar+lit_ru+ptmrkt+agrl_t+
                   log(amount)+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                 +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
  ...
  saveWorkbook(wbe,paste("/Users/tangjingwen/Dropbox/jingwen_tasks/organized/result/DiD/",timemode," inter effects removing one level removing after 2017 add month.xlsx",sep = ""),overwrite = T)
  saveWorkbook(wb,paste("/Users/tangjingwen/Dropbox/jingwen_tasks/organized/result/DiD/",timemode," inter coefficients removing one level removing after 2017 add month.xlsx",sep = ""),overwrite = T)
}
