...
Timemode = c("13-17 month","13-17 month all","13-17 month common types","13-17 month all common types",
             "13-17 week","10-17 week all","13-17 week common types","13-17 week all common types",
...
for (tm in c(6)){
  ...
  for (p in 1:length(Product)){
    ...
    for (i in 1:length(intervented1)){
      ...
      marketdat[marketdat$market==intervented1[i],][temp$date>=(lagdate3[i]+0),"inter"] = 1
    ...
    for (i in 1:length(intervented1)){
      ...
      marketdat1[marketdat1$market==intervented1[i],][temp$date>=(lagdate3[i]+0),"inter"] = 1
    ...
    write.csv(crse1,paste(product,"modal 3 months delay.csv"))
    
    
    a1 = stargazer(crse1)
   
    write(a1,paste(product,"modal 3 months delay.txt"))
  ...
  saveWorkbook(wbe,paste("/Users/tangjingwen/Dropbox/jingwen_tasks/organized/result/DiD/",timemode," inter effects 3 months delay.xlsx",sep = ""),overwrite = T)
  saveWorkbook(wb,paste("/Users/tangjingwen/Dropbox/jingwen_tasks/organized/result/DiD/",timemode," inter coefficients 3 months delay.xlsx",sep = ""),overwrite = T)
}
