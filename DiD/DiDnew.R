  ...
  for (tm in c(2)){
    ...
    for (p in 1:length(Product)){
      ...
      ree=matrix(0,45,1)
        ...
        try({
          ...
          fit9 = lm(log(modal)~ market+date+production+yield+
                      Per.Capita.GSDP+annual+total_ar+lit_ru+ptmrkt+agrl_t+
                      log(amount)+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                    +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
                    +rainfall_lead10+rainfall_lead11+rainfall_lead12+inter+0,
        ...
        try({
          ...
          fit11 = lm(log(modal)~ state+ date +production+yield+
                       Per.Capita.GSDP+annual+total_ar+lit_ru+ptmrkt+agrl_t+
                       log(amount)+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                     +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
                     +rainfall_lead10+rainfall_lead11+rainfall_lead12+ volume_fraction +0,
        ...
        try({
          ...
          fit12 = lm(log(modal)~ market+date +production+yield+annual+total_ar+lit_ru+ptmrkt+agrl_t
        ...
        try({
          ...
          fit13 = lm(log(modal)~ market+date +production+yield+annual+total_ar+lit_ru+ptmrkt+agrl_t
                     +Per.Capita.GSDP+log(amount)+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                     +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
                     +rainfall_lead10+rainfall_lead11+rainfall_lead12+inter+0,
                     data=d,weights = w)
        ...
        try({
          ...
          fit18 = lm(log(modal)~ state+ date+annual+total_ar+lit_ru+ptmrkt+agrl_t+
                       Per.Capita.GSDP+
                       log(amount)+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                     +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
                     +rainfall_lead10+rainfall_lead11+rainfall_lead12+ no.inter +0,
        ...
        try({
          ...
          fit19 = lm(log(modal)~ market+date +production+yield+
                       Per.Capita.GSDP+annual+total_ar+lit_ru+ptmrkt+agrl_t+
                       log(amount)+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                     +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
        ...
        try({
          ...
          fit20 = lm(CV~ state+ date  +annual+total_ar+lit_ru+ptmrkt+agrl_t+
                       Per.Capita.GSDP+production+yield+
                       amount+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                     +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
                     +rainfall_lead10+rainfall_lead11+rainfall_lead12+ no.inter +0,
        ...
        try({
          ...
          d = join(d,wei,by = "market",type = "left")
          d = na.omit(d)
          fit23 = lm(log(modal)~ market+date +production+yield+annual+total_ar+lit_ru+ptmrkt+agrl_t
                     +Per.Capita.GSDP+log(amount)+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                     +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
                     +rainfall_lead10+rainfall_lead11+rainfall_lead12 + inter +0,
                     data=d,weights = w)
        ...
        try({
          ...
          d = join(d,wei,by = "market",type = "left")
          d = na.omit(d)
          fit24 = lm(log(modal)~ market+date +production+yield+annual+total_ar+lit_ru+ptmrkt+agrl_t
                     +Per.Capita.GSDP+log(amount)+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                     +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
                     +rainfall_lead10+rainfall_lead11+rainfall_lead12+inter+0,
                     data=d,weights = w)
        ...
        try({
          ...
          fit26 = lm(log(modal)~ market+date +production+yield+
                       Per.Capita.GSDP+annual+total_ar+lit_ru+ptmrkt+agrl_t+
                       log(amount)+ rainfall+rainfall_lead1+rainfall_lead2+rainfall_lead3+rainfall_lead4
                     +rainfall_lead5+rainfall_lead6+rainfall_lead7+rainfall_lead8+rainfall_lead9
    ...
    saveWorkbook(wbe,paste("/Users/tangjingwen/Dropbox/jingwen_tasks/organized/result/DiD/",timemode," inter effects removing one level.xlsx",sep = ""),overwrite = T)
    saveWorkbook(wb,paste("/Users/tangjingwen/Dropbox/jingwen_tasks/organized/result/DiD/",timemode," inter coefficients removing one level.xlsx",sep = ""),overwrite = T)
  }
